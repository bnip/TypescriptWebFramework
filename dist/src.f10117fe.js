...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // We are not trying to call a function right here.
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getAll()).then(function (reponse) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // get<K extends keyof T> Sets up the generic contraint.
...
function () {
  function Eventing() {
    var _this = this; // We don't know the names of the events being passed in
    ...
    this.events = {}; // () => void as a prop tells typescript that the passed in parameter is a function
...
},{"./../utils":"node_modules/axios/lib/utils.js","./../core/settle":"node_modules/axios/lib/core/settle.js","./../helpers/buildURL":"node_modules/axios/lib/helpers/buildURL.js","../core/buildFullPath":"node_modules/axios/lib/core/buildFullPath.js","./../helpers/parseHeaders":"node_modules/axios/lib/helpers/parseHeaders.js","./../helpers/isURLSameOrigin":"node_modules/axios/lib/helpers/isURLSameOrigin.js","../core/createError":"node_modules/axios/lib/core/createError.js","./../helpers/cookies":"node_modules/axios/lib/helpers/cookies.js"}],"../../../.nvm/versions/node/v13.6.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"../../../.nvm/versions/node/v13.6.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
},{"./View":"src/views/View.ts"}],"src/views/UserForms.ts":[function(require,module,exports) {
"use strict";
...
var UserForms_1 = require("./UserForms");
...
function (_super) {
  ...
  UserEdit.prototype.onRender = function () {
    ...
    new UserForms_1.UserForm(this.regions.userForm, this.model).render();
  };
...
},{"./View":"src/views/View.ts","./UserShow":"src/views/UserShow.ts","./UserForms":"src/views/UserForms.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"../../../.nvm/versions/node/v13.6.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v13.6.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
